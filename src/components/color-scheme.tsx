...
export function ColorScheme() {
  ...
  return (
    <>
      {colorScheme === COLORSCHEME.dark ? <button className={`${styleTheme.padding.normal} h-full`} onClick={() => changeColorScheme(COLORSCHEME.light)}><MoonIcon className='h-full'/></button> : null}
      {colorScheme === COLORSCHEME.light ? <button className={`${styleTheme.padding.normal} h-full`} onClick={() => changeColorScheme(COLORSCHEME.dark)}><SunIcon className='h-full'/></button> : null}
